...
try:
    ...
    PAYMENT_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003178595762"))
    SINGLE_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003261674114"))
    BATCH_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003246924678"))
